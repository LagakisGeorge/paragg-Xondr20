...
public class addtrapezia extends AppCompatActivity {
    GridView moviesList;
    GridView prosueta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addtrapezia);
    ...
    public void SAVE (View view) {
        ...
        mydatabase.execSQL("update TABLES set ONO='"+t2.getText()+"'  where ID="+fID);
    ...
    public void NEO_EIDOS (View view) {
        ...
        mydatabase = openOrCreateDatabase("eidh",MODE_PRIVATE,null);
        String sql;
        sql="INSERT INTO  TABLES ( ONO) VALUES ('"+t2.getText()+"');";
    ...
    public void DELETE (View view) {
        ...
        mydatabase = openOrCreateDatabase("eidh", MODE_PRIVATE, null);
        mydatabase.execSQL("DELETE FROM  TABLES  where ID=" + fID);
    ...
    public void Show () {
        ...
        try{
            mydatabase = openOrCreateDatabase("eidh",MODE_PRIVATE,null);
            Cursor cursor2 = mydatabase.rawQuery("select ID,ONO  from  TABLES", null);
            String kat="";
            String syn="";
